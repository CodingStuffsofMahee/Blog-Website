...
function ErrorNotFound() {
    return (
        <div class="flex items-center overflow-hidden justify-center min-h-screen w-screen bg-indigo-500  bg-fixed bg-cover bg-bottom error-bg"
                ...
                <div class="row">
                    <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                        <div class="relative ">
                            ...
                            <span class="absolute  top-0 pb-4   -ml-12  text-gray-300 font-semibold">Oops!</span>
                        </div>
